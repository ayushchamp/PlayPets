  ...
  exposed_functions: [
    ...
    },
    {
      ...
      return: [
        ...
        "u64",
        "u64",
        "0xb686acdc6c166f92aa2090f005acc275b258c5d91653df9b3b8af21e7c104773::main::PlayPetsParts",
      ],
    },
    {
      name: "get_playpets_address",
      visibility: "public",
      is_entry: false,
      is_view: true,
      generic_type_params: [],
    ...
    {
      name: "get_playpets_collection_address",
      visibility: "public",
      is_entry: false,
      is_view: true,
      generic_type_params: [],
  ...
  structs: [
    {
      ...
      fields: [
        ...
        {
          name: "parts",
          type: "0xb686acdc6c166f92aa2090f005acc275b258c5d91653df9b3b8af21e7c104773::main::PlayPetsParts",
        },
    ...
    {
      name: "MintPlayPetsEvent",
      is_native: false,
      abilities: ["drop", "store"],
      generic_type_params: [],
      fields: [
        { name: "token_name", type: "0x1::string::String" },
        { name: "playpets_name", type: "0x1::string::String" },
        {
          name: "parts",
          type: "0xb686acdc6c166f92aa2090f005acc275b258c5d91653df9b3b8af21e7c104773::main::PlayPetsParts",
        },
