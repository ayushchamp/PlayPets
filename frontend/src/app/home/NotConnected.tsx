...
export function NotConnected() {
  ...
  const text = useTypingEffect(
    `Welcome to PlayPets! Once you connect your wallet, you'll be able to mint your new on-chain pet. Once minted, you'll be able to feed, play with, and customize your new best friend!`
  );
